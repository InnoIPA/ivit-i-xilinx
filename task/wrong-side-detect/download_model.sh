...
# Parameters
FOLDER="yolov3_voc_tf"
MODEL="yolov3_voc_tf.xmodel"

MODEL_URL="https://www.xilinx.com/bin/public/openDownload?filename=yolov3_voc_tf-zcu102_zcu104_kv260-r1.4.0.tar.gz"
MODEL_FILE="yolov3_voc_tf-zcu102_zcu104_kv260-r1.4.0.tar.gz"

LABEL_URL="https://drive.google.com/file/d/1D6Pc56U9zhzoBnuhjSaLg_1dxX59mRM2/view?usp=share_link"
LABEL_FILE="yolov3-voc.txt"
